...
<table id="structDetail" border="0" cellpadding="0" cellspacing="0"
	...
	<n:value id="a1" src="crud" service="crud_get_table_struct_service"
		serviceType="ref" p1="${param.owner}" p2="${param.table}"
		paramSize="2">
    #foreach ($i in $list)
    	<tr>
