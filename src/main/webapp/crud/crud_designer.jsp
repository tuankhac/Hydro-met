...
<n:check value="${param.owner}" minLength="3" maxLength="200"
	type="string" exp="[0-9a-zA-Z_,]+">Cần truyền Schema</n:check>
<html>
...
<body>
	<strong>Chọn bảng để thực hiện CRUD:</strong>
	<select id="combo" style="width: 400px"><n:option src="crud"
			serviceType="query" service="crud_designer_tables_service"
			paramSize="1" p1="${param.owner}" /></select>
	<input type="button" onClick="viewStruct()" value="View Struct" />
	<div id="struct"></div>
	<input id="path" type="text" style="width: 530px"
		value="<%= new java.io.File(org.apache.commons.configuration.ConfigurationUtils.locate("velocity.properties").getPath()).getParent() %>/../templates/" />
	<input type="button" onClick="makeParam()"
		value="Tạo Create-Read-Update-Delete Form" />
